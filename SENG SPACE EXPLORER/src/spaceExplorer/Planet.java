...
public class Planet extends JFrame {
	...
	public Planet() {
		...
		button_1.setBounds(13, 45, 193, 45);
		contentPane.add(button_1);
		
		JButton button_2 = new JButton(name_2);
		button_2.setBounds(13, 95, 193, 45);
		contentPane.add(button_2);
		
		JButton button_3 = new JButton(name_3);
		button_3.setBounds(13, 145, 193, 45);
		contentPane.add(button_3);
		
		JButton button_4 = new JButton(name_4);
		button_4.setBounds(13, 195, 193, 45);
		contentPane.add(button_4);
		
		JButton button_5 = new JButton("");
		button_5.setBounds(242, 77, 193, 45);
		contentPane.add(button_5);
		
		JButton button_6 = new JButton("");
		button_6.setBounds(242, 165, 193, 45);
		...
		separator.setBounds(216, 45, 10, 195);
		...
		lblNewLabel_3.setBounds(-2, 259, 222, 22);
		...
		lblClickOnThe.setBounds(3, 239, 212, 22);
